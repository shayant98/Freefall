    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li>
                    <a href="dashboard.php"><i class="fa fa-table"></i> <span class="nav-label">Dashboard</span></a>
                </li>
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li>
                    <span class="m-r-sm text-muted welcome-message">Welkom bij de Freefall CMS.</span>
                </li>
                        ...
                        <div class="ibox-content">
                            ...
                            <table class="footable table table-stripped" data-page-size="8" data-filter=#filter>
                                ...
                                <tr>
                                    <th>Project Naam</th>
                                    <th>Opdrachtgever</th>
                                    <th data-hide="phone,tablet">Freelancer</th>
                                    <th data-hide="phone,tablet">Deadline</th>
                                    <th data-hide="phone,tablet">Status</th>
                                    <th data-hide="phone,tablet">Functies</th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr class="gradeX">
                                    ...
                                    <td>Kevin Edoo</td>
                                    <td>Shayant Sital</td>
                                    <td class="center">12 jan 2018</td>
                                    <td class="center">Afgerond</td>
                                    <td>Alles</td>
                                </tr>
                                <tr class="gradeX">
                                    <td>Freefall</td>
